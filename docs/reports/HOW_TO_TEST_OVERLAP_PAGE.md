...
> Issue Template：`.github/ISSUE_TEMPLATE/manual-test-overlap.yml`（推荐：每次创建一份新 issue 逐项勾选并留痕）
> 历史追踪：https://github.com/wyjistest/human-lncrna-atlas/issues/71（已迁移模板，作为历史记录）
