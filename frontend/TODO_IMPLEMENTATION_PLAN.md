...
| # | 任务 | 当前状态 | 复杂度 | 优先级 | 预估工作量 |
|---|------|---------|--------|--------|-----------|
| 1 | SVG 导出支持 | 占位代码存在 | 中 | P1 | 1.5-2h |
| 2 | PDF 分页优化 | 已实现，需验证 | 低 | P3 | 0.5h |
| 3 | 布局算法 UI | **已实现** | 低 | P3 | 0.5h (仅验收/微调) |
| 4 | Gene 详情页 | API 就绪 | 中 | P1 | 2h |
| 5 | Disease 关联展示 | **API 已存在** | 中 | P2 | 1.5h |
| 6 | Bundle 优化 | **ECharts 已按需导入** | 低 | P3 | 0.5h |
| 7 | ESLint 规则 | 基础已有 | 低 | P3 | 0.5h |
| 8 | 单元测试配置 | 完全缺失 | 中高 | P2 | 3h |
