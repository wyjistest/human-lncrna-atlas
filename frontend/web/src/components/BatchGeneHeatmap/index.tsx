...
import { Card, Space, Select, Alert } from "antd";
import { useTranslation } from "react-i18next";
import GeneSelector from "./GeneSelector";
import BatchHeatmapMatrix from "./BatchHeatmapMatrix";
import useBatchGeneHeatmap, {
  useBatchGeneHeatmapStatus,
} from "@/hooks/useBatchGeneHeatmap";
 ...
 * 5. View large-scale matrix data
 *
 * @example
 * ```tsx
  ...
  return (
    <Space orientation="vertical" size="large" style={{ width: "100%" }}>
          ...
          <Space orientation="vertical" size="middle" style={{ width: "100%" }}>
            ...
            <div>
              ...
              <Select
                ...
                maxCount={8}
                placeholder={t(
                  "batchGeneHeatmap.selectMarksPlaceholder",
                  "Choose marks to display",
                )}
              />
            </div>
            ...
            <div>
              ...
              >
                {t(
                  "batchGeneHeatmap.selectCellTypes",
                  "Select Cell Types (Y-axis)",
                )}
              </label>
              <Select
                mode="multiple"
                ...
                maxCount={12}
                placeholder={t(
                  "batchGeneHeatmap.selectCellTypesPlaceholder",
                  "Choose cell types",
                )}
              />
            </div>
      ...
      {selectedGenes.length > 0 && (
        <Card
          title={t(
            "batchGeneHeatmap.heatmapVisualization",
