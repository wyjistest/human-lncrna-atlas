...
> 更新（2026-01-29）：下列条目已在后续提交中完成；保留用于历史追溯与审计回滚。现状以 `docs/CURRENT_STATUS.md` 与最新 `docs/ROADMAP_*.md` 为准。

- [x] 确认 CI 触发策略（保留手动 / 恢复 push / 混合）
- [x] 选定 2-4 个高风险端点扩展基线
- [x] 固化性能导出 + issue 模板（含证据链接）
- [x] 选择 ETL 校验范围与样例基线方案
- [x] 评估前端 deprecations 清理范围
